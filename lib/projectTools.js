...
function getProjectRoot (dir) {
  var insidePWA = new RegExp(constants.PWA + '$');
...
function getProjectRootForNewStructure (dir) {
  return getProjectRoot(dir).then(function (root) {
    return path.join(root, constants.POLYFILLS_FOLDER);
  });
}
...
module.exports = {
  ...
  getProjectRootForNewStructure: getProjectRootForNewStructure,
