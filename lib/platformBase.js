 ...
 */
PlatformBase.prototype.run = function (projectDir, options, callback) {
 ...
 */
PlatformBase.prototype.package = function (projectDir, options, callback) {
 ...
 */
PlatformBase.prototype.open = function (projectDir, options, callback) {
