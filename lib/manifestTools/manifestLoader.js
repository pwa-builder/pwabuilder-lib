...
function generateImagesForManifest(image, manifest, generateDataUris, callback) {
  ///TODO: Should call image service and update the manifest with the generated images.
  var deferred = Q.defer();
