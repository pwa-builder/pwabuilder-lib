...
function validateManifest(w3cManifestInfo, platforms) {
  return manifestTools.validateManifest(w3cManifestInfo, platforms).then(function (validationResults) {
...
function createApps (w3cManifestInfo, rootDir, platforms, options, callback) {
  ...
  .then(function (platformModules) {
    ...
    return validateManifest(w3cManifestInfo, platforms).thenResolve(platformModules);
  })
  .then(function (platformModules) {
